      ...
      <section className="mx-auto flex w-full max-w-4xl flex-col gap-3 sm:gap-4">
        {homeLinks.map((item, index) => (
          <Link
            ...
            to={item.to}
            className={cn(
              'w-full rounded-2xl border-2 border-white/70 bg-white/40 px-6 py-5 text-center text-4xl font-black uppercase tracking-[0.12em] text-purple-900 transition-all duration-300 backdrop-blur sm:text-5xl',
